...
from flask import Flask, redirect, render_template, request, jsonify, url_for, session,request 
...
def forgot():
    ...
    if response == "forgot":
        ...
        message = Message("MovieRecommendation | OTP for password reset", sender="your-email@gmail.com", recipients=[signin_email])
